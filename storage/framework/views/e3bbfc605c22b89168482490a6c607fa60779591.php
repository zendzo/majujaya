  ...
  <div class="col-md-12">
    <!-- general form elements -->
          <div class="box box-primary">
            ...
            <!-- /.box-header --> 
          <div class="box-body">
            <form class="form-horizontal"  action="<?php echo e(route('admin.product-type.update',$productType->id)); ?>" method="POST">
              ...
              <div class="form-group<?php echo e($errors->has('nama') ? ' has-error' : ''); ?>">
                ...
                <div class="col-sm-8">
                  <input id="nama" name="nama" type="text" class="form-control" placeholder="Nama" value="<?php echo e($productType->nama); ?>">
              ...
              <div class="form-group<?php echo e($errors->has('kode') ? ' has-error' : ''); ?>">
                ...
                <div class="col-sm-8">
                  <input id="kode" name="kode" type="text" class="form-control" placeholder="kode" value="<?php echo e($productType->kode); ?>">
              ...
              <div class="form-group<?php echo e($errors->has('deskripsi') ? ' has-error' : ''); ?>">
                ...
                <div class="col-sm-8">
                  <textarea class="form-control" name="deskripsi" placeholder="Deskripsi"><?php echo e($productType->deskripsi); ?></textarea>
