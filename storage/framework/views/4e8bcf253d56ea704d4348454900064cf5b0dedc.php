      ...
      <div class="box-body">
        <table class="table table-bordered">
          <tbody id="field_item">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $order_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <tr class="text-center">
                ...
                <td width="10%" class="text-center">
                  <form method="POST" action="<?php echo e(route('admin.orders.destroy',$item->id)); ?>" accept-charset="UTF-8" style="display:inline">
            ...
            <tr>
                ...
                <td colspan="3"><h4><?php echo e($order_items->sum('total')); ?></h4></td>
            </tr>
          </tbody>
        </table>
      </div>
