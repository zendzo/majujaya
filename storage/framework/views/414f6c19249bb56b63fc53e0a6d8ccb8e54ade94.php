  ...
  <div class="col-md-12">
    <!-- general form elements -->
          <div class="box box-primary">
            ...
            <!-- /.box-header --> 
          <div class="box-body">
            <form class="form-horizontal"  action="<?php echo e(route('admin.satuan.store')); ?>" method="POST">
              ...
              <div class="form-group<?php echo e($errors->has('symbol') ? ' has-error' : ''); ?>">
                ...
                <div class="col-sm-8">
                  <input id="symbol" name="symbol" type="text" class="form-control" placeholder="symbol" value="<?php echo e(old('symbol')); ?>">
