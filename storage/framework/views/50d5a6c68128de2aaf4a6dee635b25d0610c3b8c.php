      ...
      <!-- form start -->
        <div class="box-body form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
               <input name="kode" class="form-control" id="kode" value="<?php echo e($sale->user->fullName()); ?>" readonly="">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input name="tanggal_po" type="text" class="form-control pull-right" value="<?php echo e($sale->tanggal_kirim->format('d/m/Y')); ?>" readonly="">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
               <input name="tanggal_po" type="text" class="form-control pull-right" value="<?php echo e($sale->gudang->nama); ?>" readonly="">
            </div>
          </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
               <textarea class="form-control" name="keterangan" readonly=""><?php echo e($sale->keterangan); ?></textarea>
          </div>
        </div>
      ...
      <!-- form start -->
        ...
        <div class="box-body form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input name="kode" class="form-control" id="kode" value="<?php echo e($sale->kode); ?>" readonly="">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
               <input name="kode" class="form-control" id="kode" value="<?php echo e($sale->type->type); ?>" readonly="">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input name="tanggal_po" type="text" class="form-control pull-right" value="<?php echo e($sale->tanggal_so->format('d/m/Y')); ?>" readonly="">
            </div>
          </div>
...
<?php echo $__env->make('form_partials.list_items_transaksi_penjualan', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>


<?php if($sale->completed == true): ?>
  <?php echo $__env->make('penjualan.penjualan_completed', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php else: ?>
