...
<a href="#">
  ...
  <ul class="treeview-menu">
	   <li class="treeview ">
			...
			<ul class="treeview-menu">
				<li class=""><a href="<?php echo e(route('admin.transaksi.penjualan')); ?>">
					<i class="fa fa-arrow-circle-right"></i>Transaksi</a>
				</li>
				<li class=""><a href="<?php echo e(route('admin.revisi.transaksi.penjualan')); ?>">
		...
		<li class="treeview ">
			...
			<ul class="treeview-menu">
				<li class=""><a href="<?php echo e(route('admin.transaksi.pembelian')); ?>">
					<i class="fa fa-arrow-circle-left"></i>Transaksi</a>
				</li>
				<li class=""><a href="<?php echo e(route('admin.revisi.transaksi.pembelian')); ?>">
					<i class="fa fa-code-fork fa-rotate-180 fa-fw"></i>Revisi</a>
				</li>
			</ul>
		</li>
