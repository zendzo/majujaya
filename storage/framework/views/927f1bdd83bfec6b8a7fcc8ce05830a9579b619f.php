...
<a href="#">
  ...
  <ul class="treeview-menu">
    <li><a href="<?php echo e(route('admin.penjualan.index')); ?>"><i class="fa fa-shopping-cart"></i>Penjualan</a></li>
    <li><a href="<?php echo e(route('admin.pembayaran.penjualan')); ?>"><i class="fa fa-credit-card"></i>Pembayaran</a></li>
