...
class ConfirmedPesananSmsNotification extends Notification
{
    use Queueable;
    ...
    public function toSmsGateway($notifiable)
    {
        ...
        $content = "Sdr. $user Kd.Nota Pesanan Anda $kode_penjualan Adalah Sebesar $total Telah Dikonfirmasi!";
